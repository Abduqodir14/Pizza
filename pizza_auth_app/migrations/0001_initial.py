    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                max_length=30, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$',
                ...
                ('favourite_pizza', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE,
